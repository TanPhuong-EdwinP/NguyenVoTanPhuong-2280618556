...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_plain_2 = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_plain_2.setGeometry(QtCore.QRect(110, 80, 391, 71))
        self.txt_plain_2.setObjectName("txt_plain_2")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(260, 30, 91, 16))
        ...
        self.txt_plain.setGeometry(QtCore.QRect(30, 90, 47, 13))
        self.txt_plain.setText("")
        self.txt_plain.setObjectName("txt_plain")
        self.txt_key = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_key.setGeometry(QtCore.QRect(110, 180, 391, 21))
        self.txt_key.setObjectName("txt_key")
        self.plainTextEdit_3 = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.plainTextEdit_3.setGeometry(QtCore.QRect(110, 230, 391, 71))
        self.plainTextEdit_3.setObjectName("plainTextEdit_3")
        self.btn_De = QtWidgets.QPushButton(self.centralwidget)
        self.btn_De.setGeometry(QtCore.QRect(410, 320, 75, 23))
